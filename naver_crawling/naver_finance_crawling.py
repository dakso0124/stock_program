...
class NaverFinanceCrawler:  # 네이버 증권 크롤링 클래스
    ...
    def get_upjong(self):  # 업종가져오기
        ...
        upjong_list = soup.find_all('td', style='padding-left:10px;')
        ...
        print(self.upjong_name_list)
        print(self.upjong_url_list)
    ...
    def upjong_tour(self):  # 업종별로 종목정보 가져오기
        for url, upjong_name in tqdm(zip(self.upjong_url_list, self.upjong_name_list)):  # 업종 순회 for문
            ...
            if self.last_upjong is not None and upjong_name is not self.last_upjong:    # 중간에 끊겼다면
                continue
            elif self.last_upjong is not None and upjong_name == self.last_upjong:
                self.last_upjong = None
            ...
            try:
                for company in tqdm(company_list):  # 업종별 종목 순회 for문
                    ...
                    self.get_comany_info(code, company.a.string)
            except:
                print('======================================================================= except')
                print('======================================================================= except')
                print('======================================================================= except')
    ...
    def get_comany_info(self, company_code, company_name):  # 종목별 정보 가져오기
        ...
        co_page = urlopen('https://navercomp.wisereport.co.kr/v2/company/c1020001.aspx?cmp_cd=' + company_code + '&cn=')
